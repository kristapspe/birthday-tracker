...
#Every year that is exactly divisable by 4 is a leap year
# Excepy that devide by 100
...
def days_till(month, day:int) ->int:
    """
    Arguments:
    ...
    returns number of days till the next month,
    for example, 7th of july.
